...
> **Umsetzungsstand:** Die Blöcke 1 bis 5 sind abgeschlossen. Block 2 stellt das aktivierbare Plugin-Grundgerüst und die Basis-CI bereit. Die Blöcke 3 bis 5 ergänzen im getrennten Website-Projekt die zusätzliche Embed-API mit stabilen Referenzen, zentraler Freigabeprüfung, öffentlichem Datenadapter, versioniertem Metadaten-Endpunkt und eigenständiger Tabellenansicht. Die Nachweise stehen unter [`docs/block-02`](./docs/block-02/IMPLEMENTATION.md), [`docs/block-03`](./docs/block-03/IMPLEMENTATION.md), [`docs/block-04`](./docs/block-04/IMPLEMENTATION.md) und [`docs/block-05`](./docs/block-05/IMPLEMENTATION.md). Spielplan, Filter und Live-Aktualisierung folgen in Block 6.
