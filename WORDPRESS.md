...
> **Umsetzungsstand:** Die Blöcke 1 bis 6 sind abgeschlossen. Block 2 stellt das aktivierbare Plugin-Grundgerüst und die Basis-CI bereit. Die Blöcke 3 bis 6 ergänzen im getrennten Website-Projekt die zusätzliche Embed-API mit stabilen Referenzen, zentraler Freigabeprüfung, öffentlichem Datenadapter, versioniertem Metadaten-Endpunkt sowie eigenständigen Tabellen- und Spielplanansichten. Der Spielplan unterstützt kombinierte Filter und eine sichtbarkeitsabhängige konditionale Aktualisierung. Die Nachweise stehen unter [`docs/block-02`](./docs/block-02/IMPLEMENTATION.md), [`docs/block-03`](./docs/block-03/IMPLEMENTATION.md), [`docs/block-04`](./docs/block-04/IMPLEMENTATION.md), [`docs/block-05`](./docs/block-05/IMPLEMENTATION.md) und [`docs/block-06`](./docs/block-06/IMPLEMENTATION.md).
