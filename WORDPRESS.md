...
> **Umsetzungsstand:** Die Blöcke 1 bis 4 sind abgeschlossen. Block 2 stellt das aktivierbare Plugin-Grundgerüst und die Basis-CI bereit. Die Blöcke 3 und 4 ergänzen im getrennten Website-Projekt die zusätzliche Embed-API mit stabilen Referenzen, zentraler Freigabeprüfung, öffentlichem Datenadapter und versioniertem Metadaten-Endpunkt. Die Nachweise stehen unter [`docs/block-02`](./docs/block-02/IMPLEMENTATION.md), [`docs/block-03`](./docs/block-03/IMPLEMENTATION.md) und [`docs/block-04`](./docs/block-04/IMPLEMENTATION.md). Embed-Layout und Turniertabelle folgen in Block 5.
